...
public class Constants {
    ...
    public static final int LIMIT_CERTIFICATION = 10;
    ...
    //Post
    public static final int LIMIT_POST_NEW = 10;
    //Size giày
    public static final List<Integer> SIZE_VN = new ArrayList<>(Arrays.asList(200, 300, 500));
